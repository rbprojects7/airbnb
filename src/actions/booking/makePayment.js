...
export function makePayment(
  ...
  return async (dispatch, getState, { client }) => {
    ...
    try {
        ...
        mutation createReservation(
          ...
          $totalSessionHours: Float!
            ...
            createReservation(
              ...
              chosenBlockData: $chosenBlockData,
              isParent: $isParent,
              child: $child,
              startTime: $startTime,
              endTime: $endTime,
     ...
     // console.log("testagain==",checkIn,checkOut);
     ...
     // console.log("testagainafter==",checkIn,checkOut);
      if(data && data.createReservation){
        ...
        if (paymentType == 1) {
          ...
          let reservationDetails = {
            ...
            chosenBlockData: JSON.parse(chosenBlockData),
            isParent,
            child
          };
