...
import {initializeBooking} from './initializeBooking';
...
export function bookingProcess(listId, guests, startDate, endDate, preApprove, chosenBlock) {
  ...
  return async (dispatch, getState, { client }) => {
    ...
    try {
      ...
      if(data && data.UserListing) {
        ...
        // dispatch(initializeBooking(chosenBlock));
