...
import ReservationLearningAim from './ReservationLearningAim';
...
//Usser cancellation type
import UserCancellationType from './UserCancellationType';
...
// CHILD - Releation with other Tables
...
Listing.hasMany(UserCancellationType, {
    foreignKey: 'listId',
    as: 'userCancellationType',
    onUpdate: 'cascade',
    onDelete: 'cascade',
});
