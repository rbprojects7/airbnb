              ...
              <div className={s.panelBody}>
                ...
                <ul className={s.listStyle}>
                  <li>
                    ...
                    <div>
                        <Link to={"/user/photo"}><FormattedMessage {...messages.profilePhoto} /></Link>
                    </div>
                    <div>
                        <Link to={"/user/editChild"}><FormattedMessage {...messages.completeYourChildProfile} /></Link>
                    </div>
                    <div>
                        <Link to={"/user/verification"}><FormattedMessage {...messages.verifyYourEmail} /></Link>
                    </div>
                  </li>
                </ul>
              </div>
            </Panel>
            <Panel className={cx(s.panelBorder,s.panelHeader)} header={messageCount}>
              <UnreadMessages
                userId={userId}
                loading={loading}
                getUnreadThreads={getUnreadThreads}
              />
              <Link to={"/inbox"}><FormattedMessage {...messages.allMessages} /></Link>
            </Panel>
          </Col>
        </Row>
        </Grid>
