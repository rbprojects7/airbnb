  ...
  render() {
            ...
            <div className={cx(s.parent)}>
              <div className={cx(s.children)}>
                <div className={cx(s.content)} >
                  {
                    wishListCover && wishListCover.listData && wishListCover.listData.coverPhoto && wishListCover.listData.listPhotos && <div>
                      <ListCoverPhoto
                        className={cx(s.imageContent)}
                        coverPhoto={wishListCover.listData.coverPhoto}
    ...
    /*return (
      <div>
        ...
        <div className={s.infoContainer}>
          <Link className={s.linkContainer} to={"/experience/" + id}>
            <Row>
              <Col
                xs={12}
                sm={12}
