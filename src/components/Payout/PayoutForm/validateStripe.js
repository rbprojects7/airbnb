...
const validate = values => {
    ...
    if (!values.sortCode) {
        errors.sortCode = messages.payouttSortCodeRequired;
    } else if (isNaN(values.sortCode) || (parseInt(values.sortCode, 10) < 1)) {
        errors.sortCode = messages.payoutSortCodeInvalid;
    }
