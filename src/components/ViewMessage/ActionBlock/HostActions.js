...
class HostActions extends Component {
	...
	inquiry(guestDisplayName) {
		...
		return (
			<Panel className={cx(s.space5, s.contextPadding)}>
				<h4>
					<strong><FormattedMessage {...messages.hostAction1} /> {guestDisplayName} 
					{/* <FormattedMessage {...messages.hostAction2} /> */}
					</strong>
				</h4>
				{/* <p className={s.spaceTop2}>
					<FormattedMessage {...messages.hostAction3} />
					{guestDisplayName}
					<FormattedMessage {...messages.hostAction4} />
				</p> */}
				{/* {
				...
				<Col md={12} className={cx(s.spaceTop2, s.noPadding)}>
					...
					<Button
						className={cx(s.btnPrimaryBorder, s.btnRight)}
		...
		return (
			<Panel className={cx(s.space5, s.contextPadding)}>
				<h4>
					<strong>
						{guestDisplayName}  {' '}
						<FormattedMessage {...messages.guestRequest} />
					</strong>
				</h4>
				{
					distance > 0 && <p className={s.spaceTop2}>
						{/* <FormattedMessage {...messages.hostResponseTime1} />
						<CountDown options={options} />
						<FormattedMessage {...messages.hostResponseTime2} /> */}
						<FormattedMessage {...messages.hostResponseTime3} />
					</p>
				}
				<Col
					md={12}
	...
	completedReview() {
        return (
            <Panel className={cx(s.space5, s.contextPadding)}>
                <h4><strong>You have a reflection</strong></h4>
                <p className={s.spaceTop2}>
                    Please go to your Previous Booking section to view the reflection.
                </p>
            </Panel>
        );
    }
