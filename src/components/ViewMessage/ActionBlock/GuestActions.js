...
class GuestActions extends Component {
        ...
        return (
            <Panel className={cx(s.space5, s.contextPadding)}>
                ...
                <Col xs={12} sm={12} md={12} lg={12} className={cx(s.spaceTop2, s.noPadding)}>
                    <Link to={`/experience/${listId}`} className={cx(s.linkBtn, s.btnPrimary)}><FormattedMessage {...messages.RequestToBook} /></Link>
                </Col>
            </Panel>
        );
    }
    ...
    requestToBook(hostDisplayName) {
        ...
        return (
            <Panel className={cx(s.space5, s.contextPadding)}>
                <h4><strong>Your booking request has been sent to {hostDisplayName}</strong></h4>
                <p className={s.spaceTop2}>
    ...
    expired() {
        ...
        return (
            <Panel className={cx(s.space5, s.contextPadding)}>
                ...
                <Col xs={12} sm={12} md={12} lg={12} className={cx(s.spaceTop2, s.noPadding)}>
                    <Link to={`/experience/${listId}`} className={cx(s.linkBtn, s.btnPrimary)}>
    ...
    completed() {
        return (
            <Panel className={cx(s.space5, s.contextPadding)}>
                <h4><strong>The experience is completed</strong></h4>
            </Panel>
        );
    }
