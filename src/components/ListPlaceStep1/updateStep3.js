...
import pushBlocksAndSessions from './AvailabilityAndPrice/pushBlocksAndSessions'
...
async function updateStep3(values, dispatch) {
  ...
  const blocksResponse = await pushBlocksAndSessions(values, dispatch);
  // if(blocksResponse !== 'success'){
  //   dispatch(setLoaderComplete('updateListing'));
  //   toastr.error("Update Listing Failed", "Sorry, something went wrong! Reload this page and try again!");
