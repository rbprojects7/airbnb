...
class Moderate extends React.Component {
  ...
  render() {
    ...
    return (
      <div>
          <div >
          <h3>Moderate: Full refund 5 days prior to first day of experience</h3>
          ...
          <Row>
            <Col md={4} lg={4}>
            <p>
              For a full refund of experience fees, cancellation must be made five full days prior to listing’s local start time (or 3:00 PM if not specified) on the start day. For example, if start is on Friday, cancel by the previous Sunday before start time.
            </p>
            </Col>
            <Col md={4} lg={4}>
            <p>
              If the parent cancels less than 5 days in advance, the first day is non-refundable but 50% of the experience fees for remaining nights will be refunded.
            </p>
            </Col>
            <Col md={4} lg={4}>
            <p>
              If the child arrives and decides to leave early, 50% of the experience fees for the days not spent 24 hours after the cancellation occurs are refunded.
            </p>
            </Col>
          </Row>
      </div>
