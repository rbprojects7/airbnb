        ...
        <Grid>
          <Row className={s.landingContainer}>
            ...
            <p className={s.textGray}>
              <span className={s.siteTitleBold}>{siteName}</span> allows hosts to choose among three standardised cancellation policies (Flexible, Moderate, and Strict) that we will enforce to protect both guest and host alike.</p>
            <p className={s.textGray}>
                         Each listing and reservation on our site will clearly state the cancellation policy. 
                         Parents may cancel and review any penalties by viewing their travel plans and then clicking ‘Cancel’ on the appropriate reservation. 
                         A mentor will be able to see the number of reservations a parent has cancelled over the previous 12 months when the parent submits a request to book.
