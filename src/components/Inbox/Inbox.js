        ...
        return (
            <div className={cx(s.progressContainerResponsive, s.space5, s.spaceTop5)}>
                        ...
                        <Col sm={12} md={7} lg={7} className={s.h4}>
                            <ul className={cx("list-inline", s.tabs)}>
                                <li className={guestActive}>
                                    <a className={s.tabItem} href="javascript:void(0)" onClick={() => this.changeType('guest')}>
                                        <span>Learning</span>
                                        {
                    guest != null && <Badge className={s.count}>{guest}</Badge>
                  }
                                    </a>
                                </li>
                                <li className={hostActive}>
                                    <a className={s.tabItem} href="javascript:void(0)" onClick={() => this.changeType('host')}>
                                        <span>Mentoring</span>
                                        {
              ...
              && <EmptyInbox type={type} />
                                ...
                                {
              GetAllThreads && GetAllThreads.threadsData && GetAllThreads.count > 0
              && <div>
                  <CustomPagination
