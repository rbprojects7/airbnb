...
class Reviews extends React.Component {
  ...
  render() {
    ...
    if (reviewsCount === 0) {
      return (
        <Row className={cx(s.pageContent)}>
          <Col xs={12} sm={12} md={8} lg={8} className={cx(s.space4, s.spaceTop4)}>
            <h2 className={cx(s.sectionTitleText)}><FormattedMessage {...messages.noReviewTitle} /></h2>
            <p className={s.textMuted}><FormattedMessage {...messages.noReviewInfoStep1} /></p>
          </Col>
        </Row>
      );
    }
    ...
    return (
	    <Row className={cx(s.pageContent)}>
        <Col xs={12} sm={12} md={8} lg={8} className={cx(s.space2, s.spaceTop4)}>
          <h2 className={cx(s.sectionTitleText)}>
            ...
            <span> <StarRating value={starRatingValue} className={s.starReview} /> </span>
          </h2>
          {
