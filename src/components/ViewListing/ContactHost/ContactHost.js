...
class ContactHost extends React.Component {
  static propTypes = {
    ...
    contactHostClose: PropTypes.func.isRequired,
  ...
  render() {
    ...
    const { availability, startDate, endDate, isLoading } = this.props;
          ...
          <div className={cx(s.modalTable)}>
            <div className={cx(s.modalCell)}>
              <Modal.Header className={s.modalHeading} closeButton>
                <Modal.Title><FormattedMessage {...messages.contactMentor} /></Modal.Title>
              </Modal.Header>
                  ...
                  <Row className={s.noMargin}>
                    ...
                    <Col md={8} className={s.noPadding}>
                      ...
                      >
                        ...
                        { this.renderWarningBlock(<FormattedMessage {...messages.hostErrorMessage3} />)}
                          {/* {
                            !isDateChosen && this.renderWarningBlock(<FormattedMessage {...messages.hostErrorMessage3} />)
                          }
                          {
                            !availability && isDateChosen && this.renderWarningBlock(<FormattedMessage {...messages.hostErrorMessage2} />, "error")
                          }
                          {
                              ...
                              <Row>
                                <Form onSubmit={handleSubmit(submit)}>
                                  ...
                                  <Col lg={12} md={12} sm={12} xs={12} className={s.spaceTop2}>
                                    ...
                                    <Button className={cx(s.btn, s.btnPrimary)} type="submit">
