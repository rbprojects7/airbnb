...
class BookingForm extends Component {
  ...
  render() {
    ...
    const { bookingProcess, serviceFees, base, rates, bookingLoading } = this.props;
    ...
    return (
      <Form>
        ...
        <FormGroup>
          {
            !isLoading && maximumStay && isDateChosen && <div className={cx(s.bookItMessage, s.spaceTop3)}>
          ...
          {
            !isLoading && !availability && isDateChosen && <div className={cx(s.bookItMessage, s.spaceTop3)}>
              <p className={cx(s.noMargin, s.textCenter, s.textError)}>
        ...
        {
          !maximumStay && availability && isDateChosen && <BillDetails
            basePrice={basePrice}
