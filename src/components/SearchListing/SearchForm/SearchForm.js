...
class SearchForm extends React.Component {
  static propTypes = {
    ...
    openSearchFilter: PropTypes.func,
    closeSearchFilter: PropTypes.func,
    closeAndSubmitSearchFilter:  PropTypes.func,
    ...
    return (
      <div className={cx(s.filters, 'SearchPageForm')}>
        ...
        <div className={cx(s.filterSection, s.introSection)}>
            <Row>
              <Col lg={3} md={3} sm={12} xs={12} className={cx(s.sectionLabel)}>
        ...
        <div className={cx(s.filterSection)}>
         ...
         <Row>
              ...
              <Col md={6} lg={6} className={cx(s.hideSm)}>
                <span>{total} {total > 1 ? <FormattedMessage {...messages.experiences} /> : <FormattedMessage {...messages.exprience} />}</span>{location && <span>&nbsp;&#183;&nbsp;</span>}<span>{location}</span>
              </Col>
            </Row> 
          </div> 
