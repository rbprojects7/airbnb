...
export const GET_CHILD_DATA_START = 'SET_CHILD_DATA_START';
export const GET_CHILD_DATA_SUCCESS = 'SET_CHILD_DATA_SUCCESS';
export const GET_CHILD_DATA_ERROR = 'SET_CHILD_DATA_ERROR';
...
export const BOOKING_PROCESS_INITIALIZE = 'BOOKING_PROCESS_INITIALIZE';
...
// Update Star Listing
export const UPDATE_STAR_LISTING_START = 'UPDATE_STAR_LISTING_START';
export const UPDATE_STAR_LISTING_SUCCESS = 'UPDATE_STAR_LISTING_SUCCESS';
export const UPDATE_STAR_LISTING_ERROR = 'UPDATE_STAR_LISTING_ERROR';

// Update Time 
export const SET_UPDATE_TIME_START = 'SET_UPDATE_TIME_START';
export const SET_UPDATE_TIME_COMPLETE = 'SET_UPDATE_TIME_COMPLETE';

//Cancellation Policies
export const GET_CANCELLATION_DETAILS_START = 'GET_CANCELLATION_DETAILS_START';
export const GET_CANCELLATION_DETAILS_SUCCESS = 'GET_CANCELLATION_DETAILS_SUCCESS';
export const GET_CANCELLATION_DETAILS_ERROR = 'GET_CANCELLATION_DETAILS_ERROR';

// View Listing - Image View Lightbox
export const SET_LOCALE_COOKIES_DISCLAIMER_START = 'SET_LOCALE_COOKIES_DISCLAIMER_START';
export const SET_LOCALE_COOKIES_DISCLAIMER_ERROR = 'SET_LOCALE_COOKIES_DISCLAIMER_ERROR';


// Reservation Block Data
export const GET_BLOCK_DATA_START = 'GET_BLOCK_DATA_START';
export const GET_BLOCK_DATA_SUCCESS = 'GET_BLOCK_DATA_SUCCESS';
export const GET_BLOCK_DATA_ERROR = 'GET_BLOCK_DATA_ERROR';


// Manage Listing Publish Status
export const MANANGE_ADMIN_LISTING_PUBLISH_STATUS_START = 'MANANGE_ADMIN_LISTING_PUBLISH_STATUS_START';
export const MANANGE_ADMIN_LISTING_PUBLISH_STATUS_SUCCESS = 'MANANGE_ADMIN_LISTING_PUBLISH_STATUS_SUCCESS';
export const MANANGE_ADMIN_LISTING_PUBLISH_STATUS_ERROR = 'MANANGE_ADMIN_LISTING_PUBLISH_STATUS_ERROR';

//Remove block
export const REMOVE_BLOCK_START = 'REMOVE_BLOCK_START';
export const REMOVE_BLOCK_SUCCESS = 'REMOVE_BLOCK_SUCCESS';
export const REMOVE_BLOCK_ERROR = 'REMOVE_BLOCK_ERROR';

//Payout
export const GET_PAYOUT_DETAILS_START = 'GET_PAYOUT_DETAILS_START';
export const GET_PAYOUT_DETAILS_SUCCESS = 'GET_PAYOUT_DETAILS_SUCCESS';
export const GET_PAYOUT_DETAILS_ERROR = 'GET_PAYOUT_DETAILS_ERROR';

export const UPDATE_SHOW_INTEREST_START = 'UPDATE_SHOW_INTEREST_START';
export const UPDATE_SHOW_INTEREST_SUCCESS = 'UPDATE_SHOW_INTEREST_SUCCESS';
export const UPDATE_SHOW_INTEREST_ERROR = 'UPDATE_SHOW_INTEREST_ERROR'; 

// Set Listing Address Values
export const SET_LISTING_ADDRESS_VALUES = 'SET_LISTING_ADDRESS_VALUES';


//Update Newsletter
export const UPDATE_NEWSLETTER_STARTS = 'UPDATE_NEWSLETTER_STARTS';
...
//Add child 
export const OPEN_ADD_CHILD_MODAL = 'OPEN_ADD_CHILD_MODAL';
export const CLOSE_ADD_CHILD_MODAL = 'CLOSE_ADD_CHILD_MODAL';
// Social share listing modal 
